...
WGER_SETTINGS['EMAIL_FROM'] = 'Miades Gym Manager <gym@miades.de>'
...
ADMINS = (('Miades', 'miades@miades.de'),)
MANAGERS = ADMINS

# SERVER_EMAIL = 'info@miades.de'
...
# The site's URL (e.g. http://www.miades.de or http://localhost:80)
...
#
# CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1', 'https://www.miades.de']
